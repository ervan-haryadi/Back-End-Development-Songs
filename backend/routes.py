...
def songs():
    # docker run -d --name mongodb-test -e MONGO_INITDB_ROOT_USERNAME=root
    # -e MONGO_INITDB_ROOT_PASSWORD=MTIwODMtZXJ2YW5h -e MONGO_INITDB_DATABASE=collection mongo
    # mongohost: 127.0.0.1:27017
    # MONGO URL: https://ervanaharyad-8081.theiaopenshiftnext-1-labs-prod-theiaopenshift-4-tor01.proxy.cognitiveclass.ai
